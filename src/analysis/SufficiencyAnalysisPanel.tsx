...
import { CheckCircle, AlertTriangle, XCircle, TrendingUp, BookOpen, Tag, CircleCheck } from "lucide-react";
            ...
            <div className="space-y-2">
              {topicCoverage.map((topic) => (
                <div
                  ...
                  style={{ backgroundColor: '#91E291', borderColor: '#6FCB6F' }}
                >
                  <div className="flex items-center gap-2">
                    <CircleCheck className="w-4 h-4 text-green-900" />
                    <p className="font-medium text-sm capitalize text-green-950">{topic.topic}</p>
                  </div>
                  <p className="text-sm font-semibold text-green-950">
                    {topic.required} Questions
                  </p>
                </div>
              ))}
            </div>
